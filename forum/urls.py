...
from .views import ListCreatePost,ListPostByType,PostListType,searchPostByNameOrContent,ListPostByYonghu
router = DefaultRouter()
router.register('post', ListCreatePost, basename='post')
router.register('list_yonghu', ListPostByYonghu, basename='list_yonghu')
